...
A very work in progress clip from earlier is shown here, note many things are still WIP or placeholder.
...
![your image](waterflow.gif "Current WIP visuals, showing water flow. Water is a mesh modelled in Blender, with flow maps painted onto them. Flow effect is exaggerated here.")
