...
I made a system that stores the entire level logic as a graph (what rooms you move through, what you interact with, what doors are open at any given time), and run pathfinding on that grpah to ensure the paths you have tried are valid given the information the player has learnt and is assuming.
